-- Проведем аналитику по героям в доте 2 и дадим совет новичку, каких героев брать, чтобы разносить всех)
...
-- Видно, что Slark популярен во всех регионах и занимают высокие строчки рейтинга. И отыгранных матчей много.
...
where (kills_rate = 1)
and all_match > 10
-- Но если взять героев с хорошим количеством сыгранных матчей и топ 1, можем выделить еще таких героев, как
-- Рики, Урса и Темплар Асасин. Тоже не сложные герои и на них легко убивать.
